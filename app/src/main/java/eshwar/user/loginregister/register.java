   ...
   private static final String TAG="register";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextRegisterFullName = findViewById(R.id.edit_name)
            ;
        editTextRegisterRollNo = findViewById(R.id.edit_roll_number);

        editTextRegisterEmail =findViewById(R.id.edit_email)
               ;
        editTextRegisterPassword = findViewById(R.id.edit_password);
        editTextRegisterConfirmPassword = findViewById(R.id.edit_confirm_password);
        editTextRegisterPhoneNumber = findViewById(R.id.edit_phone);
