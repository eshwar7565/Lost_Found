...
public class changepasswordactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextconfirmnewpassword = findViewById(R.id.confirmnewpasswordtextedit);

        progressBar = findViewById(R.id.progressbarforchangepassword);
        buttonauthenticate = findViewById(R.id.authenticate);
        buttonupdatepassword = findViewById(R.id.updatepasswordbuttonfinalcall);
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                buttonupdatepassword.setBackgroundTintList(ContextCompat.getColorStateList(changepasswordactivity.this,R.color.greenlight));
